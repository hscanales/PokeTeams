...
class RegionExtendedAdapter (var regiones: List<Pokemon_Regional>, val itemClickListener: OnItemClickListenerRegion) : RecyclerView.Adapter<RegionExtendedAdapter.ViewHolder>(){

    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        fun bind(poke : Pokemon_Regional, itemClickListener: OnItemClickListenerRegion) = with (itemView){
